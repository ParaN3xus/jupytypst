...
fn kernel_info() -> KernelInfoReply {
    KernelInfoReply {
        ...
        language_info: LanguageInfo {
            ...
            mimetype: Some("text/x-typst".to_string()),
            file_extension: Some(".typ".to_string()),
            pygments_lexer: Some("typst".to_string()),
            codemirror_mode: Some(CodeMirrorMode::Simple("typst".to_string())),
